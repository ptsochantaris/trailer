...
- (IBAction)phoneSettingSelected:(UIBarButtonItem *)sender {
	[[AppDelegate shared] forcePreferences];
}

- (IBAction)settingsSelected:(UIBarButtonItem *)sender {
	[[AppDelegate shared] forcePreferences];
}
	...
	if(imagePath)
	{
		[[AppDelegate shared].api getImage:imagePath
								   success:^(NSHTTPURLResponse *response, NSData *imageData) {
									   cell.imageView.image = [[UIImage imageWithData:imageData] scaleToFillSize:CGSizeMake(44, 44)];
									   [cell setNeedsLayout];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	return [pr.title sizeWithFont:[UIFont boldSystemFontOfSize:[UIFont labelFontSize]]
				constrainedToSize:CGSizeMake(190, 5000)
					lineBreakMode:NSLineBreakByWordWrapping].height+33;
}
