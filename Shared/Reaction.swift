...
final class Reaction: DataItem {
    ...
    static func sync(from nodes: LinkedList<TrailerQL.Node>, for parentType: (some DataItem).Type, on server: ApiServer, moc: NSManagedObjectContext, parentCache: FetchCache) {
